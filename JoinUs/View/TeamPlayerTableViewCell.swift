...
final class TeamPlayerTableViewCell: UITableViewCell {
    ...
    func configureCell() {
        ...
        TeamPlayerTableViewCell.teamPlayerCollectionView.register(TeamPlayerCollectionViewCell.self, forCellWithReuseIdentifier: TeamPlayerCollectionViewCell.identifier)
...
extension TeamPlayerTableViewCell: UICollectionViewDelegate {
